...
class GidItemsWidget extends StatefulWidget {
  final List<Results> products;

  const GidItemsWidget({Key? key, required this.products}) : super(key: key);

  @override
  _GidItemsWidgetState createState() => _GidItemsWidgetState();
}

class _GidItemsWidgetState extends State<GidItemsWidget> {
  bool tapped = false;
